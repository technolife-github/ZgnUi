    ...
    $().w2grid({
      ...
      columns: [
        ...
        },
        {
          ...
          field: 'Type',
          size: '100px',
          options: { items: ['Yerleştirme Noktası','Alma Noktası','Bırakma Noktası'], openOnFocus: true },
        },
      ],
      onAdd: function () {
        openPopup('İstasyon Ekle', 'AddStationForm');
        initializeOptionData('AddStationForm','GroupCodes',self.apiUrl+'Klimasan/GetGroups','GroupCode','GroupCode');
      ...
      onEdit: function (event: any) {
        ...
        initializeOptionData('UpdateStationForm','GroupCodes',self.apiUrl+'Klimasan/GetGroups','GroupCode','GroupCode');
